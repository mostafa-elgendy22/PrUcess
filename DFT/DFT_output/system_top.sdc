...
# Created by write_sdc on Fri Mar 10 19:56:59 2023
...
set_load -pin_load 0.5 [get_ports UART_transmitter_busy]
...
create_clock [get_ports reference_clk]  -name REFERENCE_CLK  -period 20  -waveform {10 20}
...
set_output_delay -clock UART_TRANSMITTER_CLK  1734.4  [get_ports UART_transmitter_busy]
...
set_clock_groups -asynchronous -name REFERENCE_CLK_1 -group [list [get_clocks REFERENCE_CLK] [get_clocks ALU_CLK]] -group [list [get_clocks UART_CLK] [get_clocks UART_TRANSMITTER_CLK]] -group [get_clocks SCAN_CLK]
