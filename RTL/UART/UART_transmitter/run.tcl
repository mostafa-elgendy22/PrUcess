...
exec cmd.exe /c "vlog UART_transmitter.v"
exec cmd.exe /c "vlog functional_verification/UART_transmitter_tb.v"
exec {*}[auto_execok start] vmap -c

if {$argc == 0} {
    # Run the testbench
    exec {*}[auto_execok start] vsim -c work.UART_transmitter_tb -do "run -all; quit -f"
    ...
    # Open the waveform
    exec {*}[auto_execok start] vsim work.UART_transmitter -do "do functional_verification/UART_transmitter.do"
