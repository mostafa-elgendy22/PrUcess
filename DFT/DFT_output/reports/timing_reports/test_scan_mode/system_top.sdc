...
# Created by write_sdc on Wed Mar 22 23:32:36 2023
...
create_generated_clock [get_pins U_clock_gating_cell/gated_clock]  -name ALU_CLK  -source [get_ports scan_clk]  -master_clock SCAN_CLK  -divide_by 1  -add
