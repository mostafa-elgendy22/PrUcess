...
exec cmd.exe /c "vlog UART_receiver.v"
exec cmd.exe /c "vlog functional_verification/UART_receiver_tb.v"
...
if {$argc == 0} {
    ...
    # Open the waveform
    exec {*}[auto_execok start] vsim work.UART_receiver -do "do functional_verification/UART_receiver.do"
